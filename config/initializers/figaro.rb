...
Figaro.require_keys("host") unless ENV["proxy_images"].blank?
auth = ENV["auth_enabled"].downcase == true unless ENV["auth_enabled"].blank?
...
if !ENV["developer_mode"] || !ENV["developer_mode"].empty?
