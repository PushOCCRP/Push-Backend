...
class ApplicationController < ActionController::Base
  ...
  def passthrough
    ...
    if ENV["cms_mode"] == "newscoop"
      url += "&ImageHeight=#{params['ImageHeight']}" unless params["ImageHeight"].nil?
      url += "&ImageWidth=#{params['ImageWidth']}" unless params["ImageWidth"].nil?
      url += "&ImageId=#{params['ImageId']}" unless params["ImageId"].nil?
    end
  ...
  def allowed_proxy_hosts
    return [] unless ENV.key? "allowed_proxy_subdomains"
